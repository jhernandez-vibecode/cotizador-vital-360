...
**Otros pendientes:**
- 🔴 **Línea clara, lo que falta: `guia-reclamos.html`** — sigue con el look anterior. Tiene cajas de alerta de color en los escenarios: aplicar el mismo criterio que JC eligió para la B (clara: la información operativa se destaca por aislamiento, no por color). Mockup primero.
