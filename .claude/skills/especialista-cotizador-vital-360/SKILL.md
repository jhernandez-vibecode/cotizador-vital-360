...
- **La B promete "(adjunto en este correo)"** para la Solicitud de Beneficios, pero solo es cierto si el agente usa el botón de adjuntar antes de enviar. Se transcribió tal cual (regla de no redactar) y se le planteó a JC el 10 sep; no respondió sobre eso. Candidato: decirlo solo cuando haya adjunto.
